      ...
      return (
        <Segment basic style={containerStyle}>
          ...
          <Form onSubmit={this.handleSubmitNewChannel}>
            ...
            <Form.Group>
              <Form.Input placeholder='DAI Token Address' width={6} label="DAI Token Address" name="TokenAddress" value={this.state.seToken._address}/>
              <Form.Input  name="Expiry" placeholder="12345678" width={6} label="Expiry Date:"/>
            </Form.Group>
  ...
  render() {
    ...
    return (
      <Segment basic>
        ...
        {/* <Button primary onClick={this.handleNewChannel()}>Create New Group</Button> */}
